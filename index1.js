...
var page33 = {
    ...
    el2: ["div", "", "select-sentence-question", "בחרו את המילה הנכונה כדי להשלים את המשפט", "sentence-question-container"],
    el3: ["div", "sentence", "sentence", "", "sentence-question-container"],
    el4: ["span", "", "", "חטיבת החילוץ וההדרכה תהווה גוף ל ", "sentence"],
    el5: ["select", "select-complete-sentence", "select-complete-1", "", "sentence", "", "select-complete-1"],
    el6: ["option", "select-default", "", "בחר:", "select-complete-1", "", "0"],
    el7: ["option", "", "", "חילוץ", "select-complete-1", "", "select-word1"],
    el8: ["option", "", "", "תכשיר", "select-complete-1", "", "select-word2"],
    el9: ["option", "", "", "בניין כוח", "select-complete-1", "", "select-word3"],
    el10: ["option", "", "", "סדיר", "select-complete-1", "", "select-word4"],
    el11: ["option", "", "", "תאמן", "select-complete-1", "", "select-word5"],
    el12: ["option", "", "", "אב''כ", "select-complete-1", "", "select-word6"],
    el13: ["option", "", "", "מילואים", "select-complete-1", "", "select-word7"],
    el14: ["option", "", "", "בתוך", "select-complete-1", "", "select-word8"],
    el15: ["option", "", "", "מחוץ", "select-complete-1", "", "select-word9"],
    el16: ["option", "", "", "הארץ", "select-complete-1", "", "select-word10"],
    el17: ["option", "", "", "חטיבה", "select-complete-1", "", "select-word11"],
    el18: ["option", "", "", "חילוץ והצלה", "select-complete-1", "", "select-word12"],
    el19: ["option", "", "", "כתום", "select-complete-1", "", "select-word13"],
    el20: ["option", "", "", "בשגרה", "select-complete-1", "", "select-word14"],
    el21: ["option", "", "", "במרחב האזרחי", "select-complete-1", "", "select-word15"],
    el22: ["option", "", "", "מפקדה משימתית", "select-complete-1", "", "select-word16"],
    el23: ["option", "", "", "מלחמה", "select-complete-1", "", "select-word17"],
    el24: ["span", "", "", "של מערך הלחימה בפקע''ר, ", "sentence"],
    el25: ["select", "select-complete-sentence", "select-complete-2", "", "sentence", "", "select-complete-2"],
    el26: ["option", "select-default", "", "בחר:", "select-complete-2", "", "0"],
    el27: ["option", "", "", "חילוץ", "select-complete-2", "", "select-word1"],
    el28: ["option", "", "", "תכשיר", "select-complete-2", "", "select-word2"],
    el29: ["option", "", "", "בניין כוח", "select-complete-2", "", "select-word3"],
    el30: ["option", "", "", "סדיר", "select-complete-2", "", "select-word4"],
    el31: ["option", "", "", "תאמן", "select-complete-2", "", "select-word5"],
    el32: ["option", "", "", "אב''כ", "select-complete-2", "", "select-word6"],
    el33: ["option", "", "", "מילואים", "select-complete-2", "", "select-word7"],
    el34: ["option", "", "", "בתוך", "select-complete-2", "", "select-word8"],
    el35: ["option", "", "", "מחוץ", "select-complete-2", "", "select-word9"],
    el36: ["option", "", "", "הארץ", "select-complete-2", "", "select-word10"],
    el37: ["option", "", "", "חטיבה", "select-complete-2", "", "select-word11"],
    el38: ["option", "", "", "חילוץ והצלה", "select-complete-2", "", "select-word12"],
    el39: ["option", "", "", "כתום", "select-complete-2", "", "select-word13"],
    el40: ["option", "", "", "בשגרה", "select-complete-2", "", "select-word14"],
    el41: ["option", "", "", "במרחב האזרחי", "select-complete-2", "", "select-word15"],
    el42: ["option", "", "", "מפקדה משימתית", "select-complete-2", "", "select-word16"],
    el43: ["option", "", "", "מלחמה", "select-complete-2", "", "select-word17"],
    el44: ["span", "", "", " ו ", "sentence"],
    el45: ["select", "select-complete-sentence", "select-complete-3", "", "sentence", "", "select-complete-3"],
    el46: ["option", "select-default", "", "בחר:", "select-complete-3", "", "0"],
    el47: ["option", "", "", "חילוץ", "select-complete-3", "", "select-word1"],
    el48: ["option", "", "", "תכשיר", "select-complete-3", "", "select-word2"],
    el49: ["option", "", "", "בניין כוח", "select-complete-3", "", "select-word3"],
    el50: ["option", "", "", "סדיר", "select-complete-3", "", "select-word4"],
    el51: ["option", "", "", "תאמן", "select-complete-3", "", "select-word5"],
    el52: ["option", "", "", "אב''כ", "select-complete-3", "", "select-word6"],
    el53: ["option", "", "", "מילואים", "select-complete-3", "", "select-word7"],
    el54: ["option", "", "", "בתוך", "select-complete-3", "", "select-word8"],
    el55: ["option", "", "", "מחוץ", "select-complete-3", "", "select-word9"],
    el56: ["option", "", "", "הארץ", "select-complete-3", "", "select-word10"],
    el57: ["option", "", "", "חטיבה", "select-complete-3", "", "select-word11"],
    el58: ["option", "", "", "חילוץ והצלה", "select-complete-3", "", "select-word12"],
    el59: ["option", "", "", "כתום", "select-complete-3", "", "select-word13"],
    el60: ["option", "", "", "בשגרה", "select-complete-3", "", "select-word14"],
    el61: ["option", "", "", "במרחב האזרחי", "select-complete-3", "", "select-word15"],
    el62: ["option", "", "", "מפקדה משימתית", "select-complete-3", "", "select-word16"],
    el63: ["option", "", "", "מלחמה", "select-complete-3", "", "select-word17"],
    el64: ["span", "", "", "את מסגרות פקע''ר ב ", "sentence"],
    el65: ["select", "select-complete-sentence", "select-complete-4", "", "sentence", "", "select-complete-4"],
    el66: ["option", "select-default", "", "בחר:", "select-complete-4", "", "0"],
    el67: ["option", "", "", "חילוץ", "select-complete-4", "", "select-word1"],
    el68: ["option", "", "", "תכשיר", "select-complete-4", "", "select-word2"],
    el69: ["option", "", "", "בניין כוח", "select-complete-4", "", "select-word3"],
    el70: ["option", "", "", "סדיר", "select-complete-4", "", "select-word4"],
    el71: ["option", "", "", "תאמן", "select-complete-4", "", "select-word5"],
    el72: ["option", "", "", "אב''כ", "select-complete-4", "", "select-word6"],
    el73: ["option", "", "", "מילואים", "select-complete-4", "", "select-word7"],
    el74: ["option", "", "", "בתוך", "select-complete-4", "", "select-word8"],
    el75: ["option", "", "", "מחוץ", "select-complete-4", "", "select-word9"],
    el76: ["option", "", "", "הארץ", "select-complete-4", "", "select-word10"],
    el77: ["option", "", "", "חטיבה", "select-complete-4", "", "select-word11"],
    el78: ["option", "", "", "חילוץ והצלה", "select-complete-4", "", "select-word12"],
    el79: ["option", "", "", "כתום", "select-complete-4", "", "select-word13"],
    el80: ["option", "", "", "בשגרה", "select-complete-4", "", "select-word14"],
    ...
    el88: ["option", "", "", "תכשיר", "select-complete-5", "", "select-word2"],
    el89: ["option", "", "", "בניין כוח", "select-complete-5", "", "select-word3"],
    el90: ["option", "", "", "סדיר", "select-complete-5", "", "select-word4"],
    el91: ["option", "", "", "תאמן", "select-complete-5", "", "select-word5"],
    el92: ["option", "", "", "אב''כ", "select-complete-5", "", "select-word6"],
    el93: ["option", "", "", "מילואים", "select-complete-5", "", "select-word7"],
    el94: ["option", "", "", "בתוך", "select-complete-5", "", "select-word8"],
    el95: ["option", "", "", "מחוץ", "select-complete-5", "", "select-word9"],
    el96: ["option", "", "", "הארץ", "select-complete-5", "", "select-word10"],
    el97: ["option", "", "", "חטיבה", "select-complete-5", "", "select-word11"],
    el98: ["option", "", "", "חילוץ והצלה", "select-complete-5", "", "select-word12"],
    el99: ["option", "", "", "כתום", "select-complete-5", "", "select-word13"],
    el100: ["option", "", "", "בשגרה", "select-complete-5", "", "select-word14"],
    el101: ["option", "", "", "במרחב האזרחי", "select-complete-5", "", "select-word15"],
    el102: ["option", "", "", "מפקדה משימתית", "select-complete-5", "", "select-word16"],
    el103: ["option", "", "", "מלחמה", "select-complete-5", "", "select-word17"],
    el104: ["span", "", "", "בתחומי ה ", "sentence"],
    el105: ["select", "select-complete-sentence", "select-complete-6", "", "sentence", "", "select-complete-6"],
    el106: ["option", "select-default", "", "בחר:", "select-complete-6", "", "0"],
    el107: ["option", "", "", "חילוץ", "select-complete-6", "", "select-word1"],
    el108: ["option", "", "", "תכשיר", "select-complete-6", "", "select-word2"],
    el109: ["option", "", "", "בניין כוח", "select-complete-6", "", "select-word3"],
    el110: ["option", "", "", "סדיר", "select-complete-6", "", "select-word4"],
    el111: ["option", "", "", "תאמן", "select-complete-6", "", "select-word5"],
    el112: ["option", "", "", "אב''כ", "select-complete-6", "", "select-word6"],
    el113: ["option", "", "", "מילואים", "select-complete-6", "", "select-word7"],
    el114: ["option", "", "", "בתוך", "select-complete-6", "", "select-word8"],
    el115: ["option", "", "", "מחוץ", "select-complete-6", "", "select-word9"],
    el116: ["option", "", "", "הארץ", "select-complete-6", "", "select-word10"],
    el117: ["option", "", "", "חטיבה", "select-complete-1", "", "select-word11"],
    el118: ["option", "", "", "חילוץ והצלה", "select-complete-6", "", "select-word12"],
    el119: ["option", "", "", "כתום", "select-complete-6", "", "select-word13"],
    el120: ["option", "", "", "בשגרה", "select-complete-6", "", "select-word14"],
    el121: ["option", "", "", "במרחב האזרחי", "select-complete-6", "", "select-word15"],
    el122: ["option", "", "", "מפקדה משימתית", "select-complete-6", "", "select-word16"],
    el123: ["option", "", "", "מלחמה", "select-complete-6", "", "select-word17"],
    el124: ["span", "", "", " וה ", "sentence"],
    el125: ["select", "select-complete-sentence", "select-complete-7", "", "sentence", "", "select-complete-7"],
    el126: ["option", "select-default", "", "בחר:", "select-complete-7", "", "0"],
    el127: ["option", "", "", "חילוץ", "select-complete-7", "", "select-word1"],
    el128: ["option", "", "", "תכשיר", "select-complete-1", "", "select-word2"],
    el129: ["option", "", "", "בניין כוח", "select-complete-7", "", "select-word3"],
    el130: ["option", "", "", "סדיר", "select-complete-7", "", "select-word4"],
    el131: ["option", "", "", "תאמן", "select-complete-7", "", "select-word5"],
    el132: ["option", "", "", "אב''כ", "select-complete-7", "", "select-word6"],
    el133: ["option", "", "", "מילואים", "select-complete-7", "", "select-word7"],
    el134: ["option", "", "", "בתוך", "select-complete-7", "", "select-word8"],
    el135: ["option", "", "", "מחוץ", "select-complete-7", "", "select-word9"],
    el136: ["option", "", "", "הארץ", "select-complete-7", "", "select-word10"],
    el137: ["option", "", "", "חטיבה", "select-complete-7", "", "select-word11"],
    el138: ["option", "", "", "חילוץ והצלה", "select-complete-7", "", "select-word12"],
    el139: ["option", "", "", "כתום", "select-complete-7", "", "select-word13"],
    el140: ["option", "", "", "בשגרה", "select-complete-7", "", "select-word14"],
    el141: ["option", "", "", "במרחב האזרחי", "select-complete-7", "", "select-word15"],
    el142: ["option", "", "", "מפקדה משימתית", "select-complete-7", "", "select-word16"],
    el143: ["option", "", "", "מלחמה", "select-complete-7", "", "select-word17"],
    el144: ["button", "", "sentence-check-btn", "בדיקה", "sentence-question-container"],
    evLis145: ["sentence-check-btn", "click", "checkSelectedAnswers"]
}
...
var page34 = {
    ...
    el22: ["option", "", "", "מפקדה משימתית", "select-complete-1", "", "select-word16"],
    el23: ["option", "", "", "מלחמה", "select-complete-1", "", "select-word17"],
    el24: ["span", "", "", " בחירום ובתוך כך תפעל באירועי חילוץ והצלה בכל זירות ה", "sentence"],
    el25: ["select", "select-complete-sentence", "select-complete-2", "", "sentence", "", "select-complete-2"],
    el26: ["option", "select-default", "", "בחר:", "select-complete-2", "", "0"],
    el27: ["option", "", "", "חילוץ", "select-complete-2", "", "select-word1"],
    el28: ["option", "", "", "תכשיר", "select-complete-2", "", "select-word2"],
    ...
    el42: ["option", "", "", "מפקדה משימתית", "select-complete-2", "", "select-word16"],
    el43: ["option", "", "", "מלחמה", "select-complete-2", "", "select-word17"],
    el44: ["span", "connective-letter", "", " , לרבות ", "sentence"],
    el45: ["select", "select-complete-sentence", "select-complete-3", "", "sentence", "", "select-complete-3"],
    el46: ["option", "select-default", "", "בחר:", "select-complete-3", "", "0"],
    el47: ["option", "", "", "חילוץ", "select-complete-3", "", "select-word1"],
    el48: ["option", "", "", "תכשיר", "select-complete-3", "", "select-word2"],
    ...
    el62: ["option", "", "", "מפקדה משימתית", "select-complete-3", "", "select-word16"],
    el63: ["option", "", "", "מלחמה", "select-complete-3", "", "select-word17"],
    el64: ["span", "", "", " לגבולות מדינת ישראל ותפקד על מבצעים ", "sentence"],
    el65: ["select", "select-complete-sentence", "select-complete-4", "", "sentence", "", "select-complete-4"],
    el66: ["option", "select-default", "", "בחר:", "select-complete-4", "", "0"],
    el67: ["option", "", "", "חילוץ", "select-complete-4", "", "select-word1"],
    el68: ["option", "", "", "תכשיר", "select-complete-4", "", "select-word2"],
    ...
    el82: ["option", "", "", "מפקדה משימתית", "select-complete-4", "", "select-word16"],
    el83: ["option", "", "", "מלחמה", "select-complete-4", "", "select-word17"],
    el84: ["span", "connective-letter", "", " ברגיעה ובלחימה.", "sentence"],
    el185: ["button", "", "sentence-check-btn", "בדיקה", "sentence-question-container"],
    evLis86: ["sentence-check-btn", "click", "checkSelectedAnswers"]
}

var page35 = {
    el1: ["div", "sentence-question-container", "sentence-question-container", "", "page"],
    el2: ["div", "", "select-sentence-question", "התאימו את תפקיד החטיבה לפי תחום האחריות- בשגרה או בחירום", "sentence-question-container"],
    el3: ["div", "sentence", "sentence", "", "sentence-question-container"],
    el4: ["div", "select-organize-container", "select-organize-container1", "", "sentence"],
    el5: ["span", "select-organize", "", "לתגבר את מרכז המידע הפיקודי וביצוע משימות סיוע אזרחי", "select-organize-container1"],
    el6: ["select", "select-complete-sentence", "select-complete-1", "", "select-organize-container1", "select-complete-1", ""],
    el7: ["option", "select-default", "", "בחר:", "select-complete-1", "", "0"],
    el8: ["option", "", "", "שגרה", "select-complete-1", "", "select-word1"],
    el9: ["option", "", "", "חירום", "select-complete-1", "", "select-word2"],
    el10: ["div", "select-organize-container", "select-organize-container2", "", "sentence"],
    el11: ["span", "select-organize", "", "לפתח ידע מקצועי בעולמות החילוץ והאב''כ", "select-organize-container2"],
    el12: ["select", "select-complete-sentence", "select-complete-2", "", "select-organize-container2", "select-complete-2", ""],
    el13: ["option", "select-default", "", "בחר:", "select-complete-2", "", "0"],
    el14: ["option", "", "", "שגרה", "select-complete-2", "", "select-word1"],
    el15: ["option", "", "", "חירום", "select-complete-2", "", "select-word2"],
    el16: ["div", "select-organize-container", "select-organize-container3", "", "sentence"],
    el17: ["span", "select-organize", "", "לאמן ולשמר כשירות למסגרות המילואים בפיקוד בהתאם למחזוריות האימונים", "select-organize-container3"],
    el18: ["select", "select-complete-sentence", "select-complete-3", "", "select-organize-container3", "select-complete-3", ""],
    el19: ["option", "select-default", "", "בחר:", "select-complete-3", "", "0"],
    el20: ["option", "", "", "שגרה", "select-complete-3", "", "select-word1"],
    el21: ["option", "", "", "חירום", "select-complete-3", "", "select-word2"],
    el22: ["div", "select-organize-container", "select-organize-container4", "", "sentence"],
    el23: ["span", "select-organize", "", "פו''ש על אירועי חילוץ, הצלה, בלתי קונבנציונליים ופינוי אוכלוסיה", "select-organize-container4"],
    el24: ["select", "select-complete-sentence", "select-complete-4", "", "select-organize-container4", "select-complete-4", ""],
    el25: ["option", "select-default", "", "בחר:", "select-complete-4", "", "0"],
    el26: ["option", "", "", "שגרה", "select-complete-4", "", "select-word1"],
    el27: ["option", "", "", "חירום", "select-complete-4", "", "select-word2"],
    el28: ["div", "select-organize-container", "select-organize-container5", "", "sentence"],
    el29: ["span", "select-organize", "", "לשמש בניין הכוח של גדודי החילוץ וההצלה הסדירים, בא''ח, ביה''ס לפיקוד ולמקצועות העורף ובסיס אימון יחידות פיקודי", "select-organize-container5"],
    el30: ["select", "select-complete-sentence", "select-complete-5", "", "select-organize-container5", "select-complete-5", ""],
    el31: ["option", "select-default", "", "בחר:", "select-complete-5", "", "0"],
    el32: ["option", "", "", "שגרה", "select-complete-5", "", "select-word1"],
    el33: ["option", "", "", "חירום", "select-complete-5", "", "select-word2"],
    el34: ["div", "select-organize-container", "select-organize-container6", "", "sentence"],
    el35: ["span", "select-organize", "", "לבצע אימונים והכשרות במסגרת תכנית 'זמן יקר'", "select-organize-container6"],
    el36: ["select", "select-complete-sentence", "select-complete-6", "", "select-organize-container6", "select-complete-6", ""],
    el37: ["option", "select-default", "", "בחר:", "select-complete-6", "", "0"],
    el38: ["option", "", "", "שגרה", "select-complete-6", "", "select-word1"],
    el39: ["option", "", "", "חירום", "select-complete-6", "", "select-word2"],
    el40: ["button", "", "sentence-check-btn", "בדיקה", "sentence-question-container"],
    evLis41: ["sentence-check-btn", "click", "checkSelectedAnswers"]
}
...
var selected6;
var selected7;
let selectAllCorrect;
let selectCorrect = [];
var correctSelectedAnswersPage33 = ["select-word3", "select-word2", "select-word5", "select-word4", "select-word7", "select-word1", "select-word6"];
var correctSelectedAnswersPage34 = ["select-word16", "select-word17", "select-word9", "select-word15"];
var correctSelectedAnswersPage35 = ["select-word2", "select-word1", "select-word1", "select-word2", "select-word1", "select-word2"]
...
const createTextElement = (list) => {
    ...
    if (list[5]) {
        newElement.setAttribute("name", list[5]);
    }
    if (list[6]) {
        newElement.setAttribute("value", list[6]);
    }
}
...
var nextPage = () => {
    if (currPage === 1 && !quesVisited) {
        ...
        if (currPage === 1) {
            ...
            videoEnded();
            basicNextPage();
        } else if (currPage === 33 || currPage === 34 || currPage === 35) {
            document.getElementById("sentence-check-btn").removeEventListener("click", nextPage);
            basicNextPage();
        } else if (currPage === 41) {
            document.getElementById("page").innerHTML = "";
